...
Season \textbf{lamb} (\textit{Large Bowl~\#1}) with 1~Tbsp. \textbf{salt} and 1~tsp. \textbf{pepper} ---
...
\begin{enumerate}
    ...
    \item Add 1~Tbsp. \textbf{salt}; stir to combine. Immediately add \textbf{chicken~broth} and use a wooden spoon to scrape bottom of pot vigorously, releasing all browned bits. Add \textbf{diced~tomatoes} with their juices. Bring to a simmer.
    
    \item Return browned \textbf{lamb} and any accumulated juices to pot. Add drained \textbf{chickpeas} and 1~cup chopped \textbf{apricots} (\textit{Medium Bowl~\#2}). Stir to combine. The liquid should come about \nicefrac{3}{4} of the way up the solids; add additional \textbf{broth} if needed.
    
    \item Bring to a full simmer on stovetop. Cover with tight-fitting lid and transfer to preheated \textit{300°F} oven.
    
    \item Braise for \textit{3-3\nicefrac{1}{2}~hours}, checking at \textit{2\nicefrac{1}{2}~hours}. \textbf{Lamb} should be pull-apart tender and \textbf{chickpeas} should be creamy. If liquid level seems low at the \textit{2\nicefrac{1}{2}~hour} check, add \nicefrac{1}{2}-1~cup hot \textbf{broth}. If stew seems too liquidy, crack lid slightly for final \textit{30-45~minutes}.
    ...
    \item Stir in remaining \nicefrac{1}{2}~cup chopped \textbf{apricots} (\textit{Medium Bowl~\#2}), \textbf{fresh cilantro} (1~cup, \textit{Small Bowl~\#4}), \textbf{lemon juice} (\nicefrac{1}{2}~cup), and 3~Tbsp. \textbf{honey}. Taste and adjust seasoning with additional \textbf{salt} if needed. Let rest for \textit{10-15~minutes} before serving.
