...
\noindent
    ...
    Vegetable oil \dotfill \textonequarter{} cup \\
    ...
    Dried apricots \dotfill 1\textonehalf{} cups \\
    Fresh cilantro \dotfill 1 cup \\
    Fresh lemon juice \dotfill \textonehalf{} cup \\
...
Pat dry \textbf{lamb} and cut into 1\textonehalf{}" cubes ---
Season \textbf{lamb} with 1~Tbsp. \textbf{salt} and 1~tsp. \textbf{pepper} ---
Dice 2~large \textbf{onions} ---
Mince 8-10 \textbf{garlic} cloves ---
Chop 1\textonehalf{}~cups \textbf{apricots} into \textonequarter{}" pieces ---
Measure all \textbf{spices} (5~Tbsp. \textbf{berbere}) ---
Chop 1~cup \textbf{cilantro}

\begin{enumerate}
    \item Heat 6-quart enameled dutch oven over medium-high heat. Add 2~Tbsp. \textbf{oil}. Working in 3-4~batches to avoid crowding, brown 3~lbs. \textbf{lamb~cubes} on multiple sides until deeply caramelized, about \textit{8-10~minutes} per batch, adding more \textbf{oil} as needed (up to \textonequarter{}~cup total). Transfer browned \textbf{lamb} to a large bowl and set aside.
    
    \item Reduce heat to medium. If pot is dry, add final portion of \textbf{oil} (remaining from \textonequarter{}~cup). Add diced \textbf{onions} and cook, stirring occasionally, until softened and golden brown, about \textit{8-10~minutes}. Add minced \textbf{garlic} cloves and cook, stirring constantly, for \textit{1-2~minutes} until fragrant.
    ...
    \item Return browned 3~lbs. \textbf{lamb} and any accumulated juices to pot. Add drained \textbf{chickpeas} and 1~cup chopped \textbf{apricots}. Stir to combine. The liquid should come about \textthreequarters{} of the way up the solids; add additional \textbf{broth} if needed.
    
    \item Bring to a full simmer on stovetop. Cover with tight-fitting lid and transfer to preheated \textit{300°F} oven.
    
    \item Braise for \textit{4~hours}, checking at \textit{3\textonehalf{}~hours}. \textbf{Lamb} should be pull-apart tender and 2~cups \textbf{chickpeas} should be creamy. If liquid level seems low at the \textit{3\textonehalf{}~hour} check, add \textonehalf{}-1~cup hot \textbf{broth}. If stew seems too thin, crack lid slightly for final \textit{30~minutes}.
    ...
    \item Stir in remaining \textonehalf{}~cup chopped \textbf{apricots}, 1~cup \textbf{fresh~cilantro}, \textonehalf{}~cup \textbf{lemon~juice}, and 3~Tbsp. \textbf{honey}. Taste and adjust seasoning with additional \textbf{salt} if needed. Let rest for \textit{10-15~minutes} before serving.
...
\begin{itemize}
    ...
    \item Cut \textbf{lamb} into uniform 1\textonehalf{}" cubes for even cooking
...
\begin{itemize}
    ...
    \item Quality \textbf{berbere} blends vary significantly in heat level and complexity; taste yours to gauge intensity
    \item Ethiopian berbere typically contains fenugreek, cardamom, black pepper, coriander, cumin, chiles, ginger, and warm spices
...
\begin{itemize}
    ...
    \item Check liquid level at \textit{3\textonehalf{}~hours}; ovens and pots vary, so adjustment may be needed
