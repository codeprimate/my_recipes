...
\noindent
    ...
    \columnbreak
    Berbere spice blend \dotfill 3½ Tbsp. \\
...
\begin{enumerate}
    ...
    \item Add remaining ½~Tbsp. \textbf{berbere} and 1~Tbsp. \textbf{salt}; stir to combine. Immediately add \textbf{chicken~broth} and use a wooden spoon to scrape bottom of pot vigorously, releasing all browned bits. Add \textbf{diced~tomatoes} with their juices. Bring to a simmer.
