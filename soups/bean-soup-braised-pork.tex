...
Dice \textbf{onion}, \textbf{carrots}, \textbf{celery} to \nicefrac{1}{2}~inch; combine in \textit{Medium Bowl~\#1} ---
Grate \textbf{parsnip}; set aside in \textit{Small Bowl~\#1} ---
Clean and slice \textbf{leeks} into \nicefrac{1}{2}~inch half rounds; set aside in \textit{Medium Bowl~\#2} ---
Mince \textbf{garlic}; set aside in \textit{Small Bowl~\#2} ---
Hand-crush \textbf{San Marzano tomatoes} in \textit{Medium Bowl~\#3}
...
\begin{enumerate}
    ...
    \item In large Dutch oven or heavy pot (\textit{8+~quart}), heat 3~Tbsp. \textbf{fat or lard} over medium heat. Add diced \textbf{onion}, \textbf{carrots}, \textbf{celery} (\textit{Medium Bowl~\#1}), \textbf{leeks} (\textit{Medium Bowl~\#2}), and grated \textbf{parsnip} (\textit{Small Bowl~\#1}). Sauté for \textit{10-12~minutes} until vegetables are softened and beginning to caramelize.
    
    \item Add minced \textbf{garlic} (\textit{Small Bowl~\#2}) and cook for \textit{1-2~minutes} until fragrant. Add 3~Tbsp. \textbf{tomato paste} and cook, stirring constantly, for \textit{2-3~minutes} until paste darkens and becomes fragrant.
    
    \item Deglaze with \nicefrac{1}{2}~cup \textbf{red wine}, scraping up any browned bits from bottom of pot. Simmer until \textbf{wine} reduces by half, about \textit{3-4~minutes}.
    
    \item Add soaked and drained \textbf{beans}, hand-crushed \textbf{tomatoes} with juices (\textit{Medium Bowl~\#3}), \textbf{braising liquid}, 1~Tbsp. \textbf{hot sauce}, reserved \textbf{rib bones}, 2~ \textbf{bay leaves}, 4-5~ \textbf{thyme sprigs}, and 1~tsp. \textbf{white pepper}. Add 6~cups \textbf{chicken stock}.
    
    \item Bring to boil, then reduce to gentle simmer. Cover and cook for \textit{2-2\nicefrac{1}{2}~hours}, stirring occasionally, until \textbf{beans} are completely tender. Add additional \textbf{stock} as needed to maintain thick soup consistency.
