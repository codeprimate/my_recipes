...
\noindent
    ...
    Dry red wine \dotfill \textonehalf{} cup \\
...
Dice \textbf{onion}, \textbf{carrots}, \textbf{celery} to \textonehalf{}-inch ---
Grate \textbf{parsnip}  ---
Clean and slice \textbf{leeks} into \textonehalf{}-inch half rounds ---
Mince \textbf{garlic} ---
...
\begin{enumerate}
    ...
    \item Bring to boil, then reduce to gentle simmer. Cover and cook for \textit{2-2\textonehalf{}~hours}, stirring occasionally, until \textbf{beans} are completely tender. Add additional \textbf{stock} as needed to maintain thick soup consistency.
