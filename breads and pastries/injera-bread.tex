...
\noindent
    ...
    Active dry yeast \dotfill \nicefrac{1}{4} tsp. \\
    \columnbreak
    Salt \dotfill \nicefrac{1}{2} tsp. \\
    Baking powder \dotfill \nicefrac{1}{4} tsp. \\
...
Dissolve \textbf{yeast} in \nicefrac{1}{4}~cup warm \textbf{water} (\textit{105-110°F})

\subsection*{Day 1 (Morning)}

\begin{enumerate}
    \item In a large non-reactive bowl, dissolve \textbf{active dry yeast} in \nicefrac{1}{4}~cup warm \textbf{water} (\textit{105-110°F}). Let stand \textit{5~minutes} until foamy. \textit{(Water must be chlorine-free to allow fermentation)}
    
    \item Add \textbf{teff flour} and 2\nicefrac{1}{4}~cups room temperature \textbf{water} to yeast mixture. Whisk vigorously until completely smooth with no lumps. The batter should be thin, similar to crepe batter, and coat a spoon in a thin layer.
...
\begin{enumerate}
    \setcounter{enumi}{6}
    \item Thin batter with remaining \nicefrac{1}{2}~cup \textbf{water} if needed—it should pour easily in a thin stream and coat a spoon lightly. Gently stir in \nicefrac{1}{2}~tsp. \textbf{salt} and \nicefrac{1}{4}~tsp. \textbf{baking powder} just before cooking (do not overmix).
    ...
    \item Pour approximately \nicefrac{1}{2}~cup \textbf{batter} into the pan in a rapid spiral motion from outside edge to center, tilting pan to ensure even coverage. The entire pour should take \textit{3-4~seconds}—speed is critical for uniform thickness.
