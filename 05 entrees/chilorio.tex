...
\fancyhead[C]{\textit{Chilorio Tacos}} % Center header with recipe title
...
\noindent
    ...
    \columnbreak
    Ground cumin \dotfill \nicefrac{1}{2} tsp. \\
    Cider vinegar \dotfill \nicefrac{1}{4} cup \\
    Kosher salt \dotfill 3 tsp. \\
    Lard \dotfill \nicefrac{1}{4} cup \\
    Corn or flour tortillas \dotfill 24 \\
    Tomatillo salsa \dotfill 1\nicefrac{1}{2} cups \\
    White onion, chopped \dotfill 1\nicefrac{1}{2} cups \\
    Fresh cilantro, chopped \dotfill 1\nicefrac{1}{2} cups \\
\end{multicols}
...
Cut \textbf{pork} into 1-inch cubes; place in \textit{Large Bowl~\#1} (pork) ---
Stem and seed \textbf{ancho~chiles} ---
Tear \textbf{chiles} into large pieces ---
Peel and roughly chop \textbf{garlic}; place in \textit{Small Bowl~\#1} (aromatics) ---
Combine 2~tsp. \textbf{oregano}, 1~tsp. \textbf{black~pepper}, and \nicefrac{1}{2}~tsp. \textbf{cumin} in \textit{Small Bowl~\#2} (spices) ---
Juice fresh \textbf{oranges} ---
Chop \textbf{onion} and \textbf{cilantro}; combine in \textit{Small Bowl~\#3} (serving)

\begin{enumerate}
    \item Heat a dry cast-iron skillet or comal over medium heat. Working in batches, toast \textbf{ancho~chile} pieces for \textit{15-30~seconds} per side until fragrant and slightly darkened. Be vigilant—burned \textbf{chiles} turn bitter. Transfer to \textit{Medium Bowl~\#1}.
    
    \item In a blender, combine \textbf{orange~juice}, toasted \textbf{ancho~chiles} (\textit{Medium Bowl~\#1}), \textbf{garlic} (\textit{Small Bowl~\#1}), 2~tsp. \textbf{oregano}, 1~tsp. \textbf{black~pepper}, and \nicefrac{1}{2}~tsp. \textbf{cumin} (\textit{Small Bowl~\#2}), \nicefrac{1}{4}~cup \textbf{vinegar}, and 3~tsp. \textbf{kosher~salt}. Blend on high until completely smooth, about \textit{1-2~minutes}. Strain through a medium-mesh sieve into \textit{Medium Bowl~\#2}, pressing solids to extract maximum flavor. Discard solids.
    
    \item Heat a large Dutch oven (at least 6-quart capacity) over medium-high heat. Working in batches to avoid crowding, sear \textbf{pork~cubes} (\textit{Large Bowl~\#1}) on at least two sides until deeply golden brown, about \textit{3-4~minutes} per side. Transfer to \textit{Large Bowl~\#2}. The rendered \textbf{pork~fat} left in the pot will contribute to the final dish—do not discard.
    
    \item Pour the strained \textbf{chile~mixture} (\textit{Medium Bowl~\#2}) into the Dutch oven. Return all \textbf{pork} (\textit{Large Bowl~\#2}) to the pot, stirring to coat evenly. The liquid should come about halfway up the \textbf{pork}—add water if needed. Bring to a simmer over medium-high heat.
