...
\begin{multicols}{2}
\noindent
    Pork shoulder, cubed \dotfill 2½ lbs \\
...
\noindent
Cut \textbf{pork~shoulder} into 1½" cubes ---
Cut \textbf{potatoes} into 1½-2" chunks ---
...
\begin{enumerate}
    ...
    \item Add \textbf{pork~cubes} and stir to coat completely with the \textbf{curry~paste} mixture. Let the \textbf{pork} sear slightly in the \textbf{paste}, stirring occasionally, for about \textit{5~minutes}. You want some browning on the meat.
    ...
    \item Bring to a boil, then reduce heat to maintain a gentle simmer. Cover partially and cook for \textit{75-90~minutes}, stirring occasionally, until \textbf{pork} is very tender and \textbf{potatoes} have softened and begun to break down slightly, thickening the sauce.
    ...
    \item While \textbf{onions} cook, heat a skillet over high heat. Sear \textbf{pineapple} chunks quickly, about \textit{1-2~minutes} per side, until lightly caramelized. Add seared \textbf{pineapple} to curry.
    ...
    \item Remove \textbf{lemongrass~stalks}. Turn off heat and stir in \textbf{lime~juice} and \textbf{lime~zest}.
    
    \item Ladle curry over steamed jasmine rice. Garnish with fresh \textbf{cilantro} and \textbf{Thai~basil} if available. Provide \textbf{lime~wedges} and the \textbf{chili~oil} on the side. For heat, drizzle \textit{1-2~tsp.} of \textbf{chili~oil} over individual portions.
\end{enumerate}
...
\begin{itemize}
    ...
    \item Cut all vegetables and \textbf{pork} before starting
...
\begin{itemize}
    \item \textbf{Pork~shoulder} (Boston butt) is essential - the intramuscular fat creates silky richness as it breaks down
    \item Use russet or Yukon gold \textbf{potatoes} for their starch content which naturally thickens the curry
...
\begin{itemize}
    ...
    \item Cut \textbf{potatoes} larger than you think - they will break down and smaller pieces will disintegrate
    \item Don't skip searing the \textbf{pineapple} - the caramelization adds complexity
    \item The curry should simmer gently, not boil hard, or the \textbf{pork} will toughen
...
\begin{itemize}
    ...
    \item Pairs well with a crisp Riesling or light lager beer
