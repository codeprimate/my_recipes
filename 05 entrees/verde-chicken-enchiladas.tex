...
\begin{multicols}{2}
\noindent
Chicken thighs, bone-in \dotfill 3~lb. \\
...
Jalapeños, medium \dotfill 2 \\
White onions, medium (divided) \dotfill 3 \\
Red bell pepper \dotfill 1 \\
Bay leaf \dotfill 1 \\
Tangerine or mandarin \dotfill 1 \\
\columnbreak
Garlic cloves (divided) \dotfill 10 \\
Fresh cilantro, chopped \dotfill \nicefrac{1}{2}~cup \\
Lime juice \dotfill 2~Tbsp. \\
Ground cumin \dotfill 1~tsp. \\
Mexican oregano \dotfill 1~tsp. \\
Salt (divided) \dotfill 1\nicefrac{1}{2}~tsp. \\
Black pepper \dotfill \nicefrac{1}{2}~tsp. \\
Vegetable oil (divided) \dotfill 3~Tbsp. \\
Corn tortillas (6-inch) \dotfill 14--16 \\
Monterey Jack cheese, shredded \dotfill 16~oz. \\
...
Drain \textbf{tomatillos}, reserving 1~cup liquid; set \textbf{tomatillos} and reserved \textbf{tomatillo liquid} aside in \textit{Medium Bowl~\#1} ---
Finely chop 1 \textbf{white onion} and 1 \textbf{red bell pepper}; set aside in \textit{Medium Bowl~\#3} ---
Halve \textbf{jalapeños} lengthwise and remove seeds and ribs ---
Quarter 1 \textbf{white onion} ---
Peel 4 \textbf{garlic cloves} ---
Combine \textbf{jalapeños}, quartered \textbf{onion}, and \textbf{garlic cloves} in \textit{Medium Bowl~\#2} (roasting aromatics) ---
...
\begin{enumerate}
    \item Prepare \textbf{chicken broth}: Combine 3~cups \textbf{water} and 1~Tbsp. \textbf{Better Than Bouillon} in a measuring cup, stirring until dissolved.
    
    \item Heat a large frying pan over \textit{medium-high} heat until hot. Place 2\nicefrac{1}{2}~lb. \textbf{chicken thighs} skin-side down in the dry pan (no oil). Cook for \textit{6-8~minutes} until skin is crisp and releases easily from the pan. Flip \textbf{chicken} and cook for \textit{5~minutes} on the other side until lightly browned. Transfer \textbf{chicken} to a plate and set aside.
    
    \item Reduce heat to \textit{medium} and sauté finely chopped \textbf{onion} and \textbf{bell pepper} (\textit{Medium Bowl~\#3}) in the rendered \textbf{chicken fat} for \textit{5-7~minutes} until softened and beginning to brown. Transfer to \textit{Large Bowl~\#2} and set aside.
    
    \item Rough chop 1 \textbf{white onion} and place in Instant Pot. Smash 6 \textbf{garlic cloves} and add to the pot. Add 1 \textbf{bay leaf}, 5~Tbsp. \textbf{Mexican spice blend}, the juice of 1 \textbf{tangerine or mandarin}, and 3~cups prepared \textbf{chicken broth}. Stir to combine. Place \textbf{chicken thighs} from the pan on top. Seal Instant Pot and cook on \textit{high} pressure for \textit{15~minutes}, then wait \textit{10~minutes} before manually releasing remaining pressure.
    
    \item While \textbf{chicken} cooks, roast the aromatics: Arrange \textbf{jalapeños}, quartered \textbf{onion}, and \textbf{garlic cloves} (\textit{Medium Bowl~\#2}) on a rimmed baking sheet, placing \textbf{jalapeños} cut-side down. Drizzle with 1~Tbsp. \textbf{vegetable oil} and toss to coat. Roast at \textit{400°F} for \textit{15-20~minutes} until \textbf{jalapeños} are blistered and slightly charred, \textbf{onion} is softened and browned at edges, and \textbf{garlic} is golden and tender. \textbf{Jalapeños} are done when skin is blistered and peppers feel soft when pressed. Remove from oven and let cool slightly.
    
    \item When Instant Pot is ready, wait \textit{10~minutes}, then manually release remaining pressure. Transfer \textbf{chicken} to a plate and let rest for \textit{5-10~minutes} until cool enough to handle. Strain the \textbf{broth} through a fine-mesh sieve and reserve 1~cup in \textit{Large Bowl~\#2} for the filling, and the remainder in \textit{Medium Bowl~\#2} for the verde sauce.
    
    \item Discard skin and bones from \textbf{chicken}, then shred into bite-sized pieces; set aside in \textit{Large Bowl~\#2}.
    
    \item Add the reserved 1~cup \textbf{chicken~broth} to the shredded \textbf{chicken} and sautéed \textbf{onion} and \textbf{bell pepper} in \textit{Large Bowl~\#2}. Combine well. Set aside.
    
    \item Transfer roasted \textbf{jalapeños}, \textbf{onion}, and \textbf{garlic} to a blender. Add \textbf{tomatillos} and 1~cup reserved \textbf{tomatillo liquid} (\textit{Medium Bowl~\#1}), 1~tsp. \textbf{cumin} and 1~tsp. \textbf{oregano} (\textit{Small Bowl~\#4}), 1~tsp. \textbf{salt}, and \nicefrac{1}{2}~tsp. \textbf{black pepper}. Blend on high for \textit{1-2~minutes} until completely smooth.
    
    \item Heat 2~Tbsp. \textbf{vegetable oil} in a large saucepan over medium-high heat until shimmering. Carefully pour in the blended \textbf{sauce} (it will sputter). Stir in remaining reserved \textbf{chicken broth} (\textit{Medium Bowl~\#2}). Reduce heat to medium and simmer, stirring occasionally, for \textit{20~minutes} until sauce darkens slightly, loses its raw flavor, and reaches the desired consistency. The sauce is ready when it coats the back of a spoon without running off immediately, is thick enough to cling to the tortillas when dipping, but still pourable for spreading over the enchiladas. Remove from heat and stir in \textbf{cilantro} (\textit{Small Bowl~\#1}) and \textbf{lime juice} (\textit{Small Bowl~\#2}). Taste and adjust \textbf{salt} (add remaining \nicefrac{1}{2}~tsp. if needed).
    
    \item Transfer approximately 2~cups of warm \textbf{sauce} to a wide, shallow bowl or pie pan for dipping tortillas; keep remaining sauce warm in the saucepan.
    
    \item Warm \textbf{corn tortillas} in the microwave wrapped in a damp paper towel for \textit{1~minute}, or heat briefly on a griddle until pliable. Working one at a time, dip each \textbf{tortilla} completely in the warm \textbf{sauce} from the bowl, coating both sides (about 2-3~seconds total). Let excess drip off briefly.
    
    \item Place sauce-coated \textbf{tortilla} on a plate. Spoon 2-3~Tbsp. \textbf{filling} (\textit{Large Bowl~\#2}) down the center, then sprinkle with 1~Tbsp. \textbf{Monterey Jack cheese} (\textit{Large Bowl~\#1}). Roll tightly and place seam-side down in the prepared baking dish. Repeat with remaining \textbf{tortillas}, arranging them snugly in the pan.
    
    \item Pour only enough warm \textbf{sauce} from the saucepan to cover the \textbf{enchiladas} fully and evenly; reserve the remainder in the saucepan for serving. Sprinkle remaining \textbf{Monterey Jack cheese} (\textit{Large Bowl~\#1}) evenly over the top, then scatter \textbf{queso fresco} (\textit{Small Bowl~\#3}) over the cheese.
    
    \item \textbf{Reduce oven temperature} to \textit{375°F}. Bake for \textit{25-30~minutes} until cheese is melted and bubbly, sauce is bubbling around edges, and enchiladas are heated through. Enchiladas are done when cheese is golden brown in spots, sauce is actively bubbling, and center of pan feels hot when tested with a knife. Continue baking in \textit{2~minute} increments if needed.
    
    \item Let rest for \textit{5~minutes} before serving. Pour reserved warm sauce over individual servings. Garnish with additional cilantro if desired. Serve hot.
\end{enumerate}
...
\begin{itemize}
    ...
    \item Large frying pan (12-inch or larger)
...
\begin{itemize}
    ...
    \item Medium Bowl \#1 --- drained \textbf{tomatillos} and reserved \textbf{tomatillo liquid} (1~cup)
    \item Medium Bowl \#2 --- \textbf{jalapeños}, quartered \textbf{onion}, and \textbf{garlic cloves} for roasting (used in step 5), then reserved \textbf{chicken broth} for verde sauce (remainder after 1~cup reserved for filling, after step 6)
    \item Medium Bowl \#3 --- finely chopped \textbf{white onion} and \textbf{red bell pepper} (used in step 3)
    \item Large Bowl \#1 --- shredded \textbf{Monterey Jack cheese} (16~oz.)
    \item Large Bowl \#2 --- sautéed \textbf{onion} and \textbf{red bell pepper} (after step 3), then reserved \textbf{chicken broth} for filling (1~cup, after step 6), then shredded \textbf{chicken} (after step 7), then \textbf{filling} (after step 8)
...
\begin{itemize}
    ...
    \item Note: There may be leftover \textbf{filling} depending on tortilla size and filling amount used; reserve for another use or serve alongside \textbf{enchiladas}
