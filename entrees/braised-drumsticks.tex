...
Peel \textbf{garlic cloves}; set aside in \textit{Small Bowl~\#1} ---
Cut \textbf{onions} into 8~wedges each; set aside in \textit{Medium Bowl~\#1} ---
Cut \textbf{carrots} into 2~inch pieces; set aside in \textit{Medium Bowl~\#2} ---
Cut \textbf{celery} into 2~inch pieces; set aside in \textit{Medium Bowl~\#3} ---
Drain \textbf{mushrooms}; set aside in \textit{Medium Bowl~\#4} ---
Zest \textbf{lemon}; set aside in \textit{Small Bowl~\#2} ---
Pat dry \textbf{drumsticks} ---
Season \textbf{drumsticks} generously with 2~tsp. \textbf{salt} and 1~tsp. \textbf{pepper}
...
\begin{enumerate}
    ...
    \item Reduce heat to medium. Add 4~Tbsp. \textbf{butter} to the Dutch oven. Once melted, add \textbf{onion} wedges (\textit{Medium Bowl~\#1}), \textbf{carrot} pieces (\textit{Medium Bowl~\#2}), and \textbf{celery} pieces (\textit{Medium Bowl~\#3}). Sauté until vegetables begin to soften and develop color, about \textit{8-10~minutes}. Add \textbf{garlic cloves} (\textit{Small Bowl~\#1}) and cook for \textit{2~minutes} more.
    
    \item Add 2~Tbsp. \textbf{tomato paste} and cook, stirring constantly, until it darkens and becomes fragrant, about \textit{2-3~minutes}.
    
    \item If using \textbf{white wine}, add \nicefrac{1}{2}~cup now and scrape up any browned bits from the bottom of the pot. Cook until wine is nearly evaporated, about \textit{3-4~minutes}. If not using wine, proceed to next step.
    
    \item Add \textbf{chicken stock}, \textbf{drained mushrooms} (\textit{Medium Bowl~\#4}), 2~tsp. \textbf{dried thyme}, 1\nicefrac{1}{2}~tsp. \textbf{dried rosemary}, 1~tsp. \textbf{dried sage}, \textbf{bay leaves}, 2~Tbsp. \textbf{Dijon mustard}, and \nicefrac{1}{2}~tsp. \textbf{MSG}. Stir to combine and bring to a simmer.
    
    \item Return \textbf{drumsticks} to the pot, nestling them into the liquid (liquid should come halfway up the drumsticks). Cover with lid and transfer to oven. Braise for \textit{1\nicefrac{1}{2}-2~hours}, until \textbf{chicken} is very tender and nearly falling off the bone.
    
    \item Remove pot from oven. Using tongs, carefully transfer \textbf{drumsticks} to a plate. Stir \textbf{lemon zest} (\textit{Small Bowl~\#2}) into the braising liquid and taste for seasoning, adjusting \textbf{salt} and \textbf{pepper} as needed.
