...
Grease and line a 9~inch×9~inch baking pan with parchment paper (leaving overhang for easy removal) ---
Toast \textbf{nuts} at \textit{350°F} for \textit{8-10~minutes} until fragrant, cool, rub in towel to remove skins if applicable, then finely chop; set aside in \textit{Small Bowl~\#1} ---
Finely chop \textbf{dried fruit}; set aside in \textit{Small Bowl~\#2} ---
Place chopped \textbf{fruit} (\textit{Small Bowl~\#2}) in warm water, soak \textit{10~minutes}, drain thoroughly, and pat dry with paper towels; return to \textit{Small Bowl~\#2}

\begin{enumerate}
    \item In \textit{Large Bowl~\#1}, combine \textbf{oats}, chopped \textbf{nuts} (\textit{Small Bowl~\#1}), 1\nicefrac{1}{2}~tsp. \textbf{cinnamon}, \nicefrac{1}{2}~tsp. \textbf{cardamom}, \nicefrac{1}{4}~tsp. \textbf{nutmeg}, and \nicefrac{1}{2}~tsp. \textbf{salt}. Mix well and set aside.
    
    \item In a medium saucepan over medium-low heat, combine \nicefrac{3}{4}~cup \textbf{butter}, \nicefrac{2}{3}~cup \textbf{corn syrup}, 2~Tbsp. \textbf{molasses}, and \nicefrac{1}{2}~cup \textbf{brown sugar}. Stir constantly until \textbf{butter} is melted and \textbf{sugar} is dissolved, about \textit{3-4~minutes}. Do not allow mixture to boil.
    
    \item Remove from heat and stir in 1~tsp. \textbf{vanilla}.
    
    \item Pour the \textbf{butter} mixture over the \textbf{oat} mixture (\textit{Large Bowl~\#1}) and stir thoroughly until all \textbf{oats} are evenly coated and mixture is well combined.
    
    \item Add the drained, chopped \textbf{fruit} (\textit{Small Bowl~\#2}) and fold in gently but thoroughly to distribute evenly throughout.
