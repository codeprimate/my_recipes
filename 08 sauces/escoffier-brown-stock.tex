...
\begin{multicols}{2}
\noindent
    Beef bones \dotfill 5--5\nicefrac{1}{2}~lb. \\
    Carrots \dotfill 5~oz. \\
    Onion \dotfill 5~oz. \\
    ...
    \columnbreak
    Beef or veal stewing meat \dotfill 2~lb. \\
    Ham knuckle \dotfill 1 small \\
    Pork rind, blanched \dotfill 5~oz. \\
...
\begin{itemize}
    \item \textbf{Bones (best types):} Use \textbf{beef} bones---marrow bones, knuckle, neck, or a mix. \textbf{Veal} bones can replace part of the beef for a more delicate, classic estouffade. Ask the butcher to cut into 2--3-inch chunks; cracking exposes marrow and improves extraction.
    \item \textbf{Stewing meat (best types):} Use gelatin-rich cuts: \textbf{beef shank}, \textbf{veal knuckle}, or \textbf{chuck}. Escoffier used both beef and veal; avoid lean cuts (e.g., round, sirloin).
    \item \textbf{Ham knuckle}: small ham hock; adds depth and a touch of smoke. Find at butchers or well-stocked grocers.
    \item \textbf{Pork rind}: buy blanched from a butcher or Asian market, or blanch in boiling water \textit{2--3~minutes}, drain, and scrape any remaining hair. Contributes body and gelatin.
\end{itemize}
